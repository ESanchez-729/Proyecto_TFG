        ...
        createAccountBtn.setOnClickListener {
            ...
            when {
                ...
                usernameText.text.isBlank()
                        ...
                        || confirmPasswordText.text.isBlank() -> {
                    Toast.makeText(this, getString(R.string.err_empty_fields), Toast.LENGTH_LONG)
                        .show()
                }

                !emailText.text.contains('@') || !emailText.text.contains('.') -> {
                    Toast.makeText(this, getString(R.string.err_invalid_email), Toast.LENGTH_LONG)
                        .show()
                }

                passwordText.text.trim().length < 6 -> {
                    Toast.makeText(this, getString(R.string.err_short_pass), Toast.LENGTH_LONG)
                        .show()
                }
                ...
                passwordText.text.toString() != confirmPasswordText.text.toString() -> {
                    Toast.makeText(
                        this,
                        getString(R.string.err_different_passwords),
                        Toast.LENGTH_LONG
                    ).show()
                }
                    ...
                    try {
                        ...
                        Toast.makeText(this, getString(R.string.err_register), Toast.LENGTH_LONG)
                            .show()
                    }
                }
            }
